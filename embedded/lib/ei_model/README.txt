...
# Edge Impulse library for terrain_classifier_WB

This is a C++ library that lets you run the impulse for "terrain_classifier_WB" (https://studio.edgeimpulse.com/studio/916506) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
